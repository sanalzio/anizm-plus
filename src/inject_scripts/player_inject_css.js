...
const anizmPlayer = ".jw-slider-horizontal.jw-chapter-slider-time .jw-slider-container .jw-timesegment-progress{background-color:hsl(from var(--primaryColorLighter)h s calc(l + 10))!important}.jw-slider-horizontal.jw-chapter-slider-time .jw-slider-container .jw-timesegment-background{background-color:hsl(from var(--primaryColor) h s l / .7)!important}.jw-slider-horizontal.jw-chapter-slider-time .jw-slider-container .jw-timesegment-buffered{background-color:hsl(from var(--primaryColorLighter) h s l / .5)!important}";
...
const players = [
    ...
    {
        url: "https://l455o.com/bkg/", // filemoon
        css: jw_logo_title + jw_margin + jw_progress_color
    }
];
